...
class Unpacker:
	def __init__(self, num):
		self.pathuav = "/home/dongwei/workspace/estimationwithoneuwb/python/hjk_feiji_"+str(num)
		self.pathugv = "/home/dongwei/workspace/estimationwithoneuwb/python/UGV_0_"+str(num)
		...
		print(self.baguav.get_start_time())
		print(self.bagugv.get_start_time())
	...
	def unpack(self):
		if os.path.exists(self.pathuav+".pkl"):
			...
			return
		print(self.baguav.get_start_time())
		for topic, msg, t in self.bagugv.read_messages(start_time = rospy.Time(self.bagugv.get_start_time()+10)):
		...
		for topic, msg, t in self.baguav.read_messages(start_time = rospy.Time(self.baguav.get_start_time()+10)):
